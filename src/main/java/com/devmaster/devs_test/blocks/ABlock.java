...
public class ABlock extends Block {
	...
	public ABlock(String name, Material material, int harvestlevel, ToolType harvesttool, int xpdropped) {
	...
	public ABlock(String name, Material material, int harvestlevel, ToolType harvesttool, float hardness, float resistance, int xpdroped) {
	...
	public ABlock(Properties properties, int xpdropped) {
		super(properties);
